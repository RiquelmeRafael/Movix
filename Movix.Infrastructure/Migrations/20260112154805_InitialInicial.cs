...
{
    /// <inheritdoc />
    public partial class InitialInicial : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UrlTrailer = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Filmes_GeneroId_ClassificacaoId",
                table: "Filmes",
                columns: new[] { "GeneroId", "ClassificacaoId" });
